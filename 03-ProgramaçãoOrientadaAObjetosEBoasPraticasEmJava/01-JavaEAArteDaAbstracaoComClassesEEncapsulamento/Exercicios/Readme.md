...
O carro deve possuir 6 marchas, ele não deve ser permitido pular uma marcha no carro;
...
Só o pet for retirado da máquina sem estar limpo será necessário limpar a máquina para permitir a entrada de outro pet;
